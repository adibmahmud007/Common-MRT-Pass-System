                ...
                <div className="md:max-w-6xl ">
                    <div className="text-white">
                        ...
                        <div className="pl-5 md:pl-32 pt-8">
                            ...
                            <div className="pt-3">
                            <label className="" htmlFor="1"><input onChange={handleSelectPerson} type="radio" name="" id="1" value='1' />1</label>
                            <label className="pl-6" htmlFor="2"><input onChange={handleSelectPerson} type="radio" name="" id="2" value='2' />2</label>
                            <label className="pl-6" htmlFor="3"><input onChange={handleSelectPerson} type="radio" name="" id="3" value='3' />3</label>
                            <label className="pl-6" htmlFor="4"><input onChange={handleSelectPerson} type="radio" name="" id="4" value='4' />4</label>
                            <label className="pl-6" htmlFor="5"><input onChange={handleSelectPerson} type="radio" name="" id="5" value='5' />5</label>
                            </div>
                        </div>
                    </div>
                </div>
