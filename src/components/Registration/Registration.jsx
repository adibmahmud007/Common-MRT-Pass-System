...
const Registration = () => {
    return (
       <div className="bg-[#101728] min-h-screen  ">
         <div className="md:p-20 ">
            <div className="p-5 md:bg-slate-300 max-w-lg mx-auto rounded-xl ">
                ...
                <div className="max-w-80 mx-auto ">
                    ...
                    <label className="input input-bordered flex items-center gap-2 mb-5 rounded-3xl">
                   ...
                   <Link to='login'> <button className="btn glass bg-blue-950 text-white text-lg px-16 ml-14">Register</button></Link>
