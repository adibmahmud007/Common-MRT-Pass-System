            ...
            <div className="p-5 md:bg-slate-300 max-w-lg mx-auto rounded-xl ">
                ...
                <form  className="max-w-80 mx-auto ">
                   ...
                   <NavLink to='login'> <button onClick={handleSubmit} className="btn glass bg-blue-950 text-white text-lg px-16 ml-14">Register</button></NavLink>
                     ...
                     <p className="mt-2 text-white md:text-black">Have an account already? click here to <span className="text-green-700 font-bold underline"><a  href="/text">Login</a></span></p>
                </form>
            </div>
        </div>
       </div>
