            ...
            <div className="md:p-10 p-2 md:grid md:grid-cols-2 gap-5">
                <Link to='/metro'><button>
                    <div className="md:pl-20 pb-3 " data-aos="fade-right">
                        ...
                        <div className=" md:w-[400px] md:h-[250px] h-[244px] rounded-xl md:ml-20 absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out bg-black bg-opacity-70">
                ...
                <Link to='/bus'><button>
                    <div className="md:pl-10 pb-3" data-aos="fade-left">
                        ...
                        <div className=" md:w-[400px] md:h-[250px] h-[244px] rounded-xl md:ml-10 absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out bg-black bg-opacity-70">
