                ...
                <section className="md:bg-white h-[450px] md:w-4/5 mx-auto rounded-lg flex md:shadow-lg md:shadow-black">
                    <div className=" ">
                        ...
                        <form className="md:pl-16 pl-2 mt-4 md:w-1/2 " action="">
                            <label onChange={handleUsernameChnage} className="input input-bordered border-black flex items-center gap-2 w-96  mb-4 rounded-2xl">
                            ...
                            <label onChange={handlePasswordChange} className="input border-black  input-bordered flex items-center gap-2 mb-4 rounded-2xl w-96">
